...
public class TipoFirma implements Serializable {
    ...
    @Column(name = "tip_precio_compra")
    private BigDecimal tipPrecioCompra;
    @Column(name = "tip_precio_venta")
    private BigDecimal tipPrecioVenta;
    ...
    public BigDecimal getTipPrecioCompra() {
        return tipPrecioCompra;
    }

    public void setTipPrecioCompra(BigDecimal tipPrecioCompra) {
        this.tipPrecioCompra = tipPrecioCompra;
    }

    public BigDecimal getTipPrecioVenta() {
        return tipPrecioVenta;
    }

    public void setTipPrecioVenta(BigDecimal tipPrecioVenta) {
        this.tipPrecioVenta = tipPrecioVenta;
    }
