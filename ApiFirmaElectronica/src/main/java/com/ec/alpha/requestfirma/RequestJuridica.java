...
public class RequestJuridica {
	public Validity validity;
	public SubjectDn subject_dn;
	public CustomExtensionsJuridica custom_extensions;
	...
	public CustomExtensionsJuridica getCustom_extensions() {
		return custom_extensions;
	}
	public void setCustom_extensions(CustomExtensionsJuridica custom_extensions) {
